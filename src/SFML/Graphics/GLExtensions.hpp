...
#include <SFML/Config.hpp>
    ...
    // SFML requires at a bare minimum OpenGL ES 1.1 capability
    ...
    #define GLEXT_blend_subtract                   OES_blend_subtract
    ...
    // Some extensions only incorporated by 1.4 are also required
    // All functionality beyond that is optional
    // and has to be checked for prior to use
    ...
    // Core since 1.4 - EXT_blend_minmax
    ...
    // Core since 1.4 - EXT_blend_subtract
